          ...
          <div> 
                            <el-table
                                ...
                                <template slot-scope="scope">
                                        ...
                                        size="mini"
                                        type="success"
                                        @click="passstudy(scope.row)">通过</el-button>
                                        <el-button
                                        size="mini"
                                        type="danger"
                                        @click="deletestudy(scope.row)">删除</el-button>
                                    </template>
                                </el-table-column>
                            </el-table>
